...
public class tareaTresFor {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        int edad = 0, contadorTotal = 0, i; 
        
        out.println("Bienvenido al menejador de riesgo bancario.");
        out.println();
        out.print("Por Favor indiqueme cuantos clientes vamos a analizar hoy: ");
        contadorTotal = Integer.parseInt(in.readLine());
        out.println();
        out.println("Perfecto hoy vamos a analizar "+contadorTotal+" casos."+"\n");
        out.println();
        

            for(i=1;i<=contadorTotal;i++){

                    out.println("Caso "+i+" de " + contadorTotal);
                    out.println();
                    out.println("Por favor complete las siguientes preguntas.");
                    out.println();
                    ...
                    out.println("\n");
                    registro= "Registro #"+i+": El usuario "+nombre+", cédula "+ cedula
